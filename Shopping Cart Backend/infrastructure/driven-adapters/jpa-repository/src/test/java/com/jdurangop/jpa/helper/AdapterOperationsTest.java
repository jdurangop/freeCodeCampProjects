package com.jdurangop.jpa.helper;

import com.jdurangop.jpa.repository.image.ImageJpaRepository;
import com.jdurangop.jpa.repository.image.ImageRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    void setUp() {
        ...
        adapter = new ImageRepositoryAdapter(repository, objectMapper);
    }
