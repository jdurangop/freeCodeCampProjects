...
--
-- Name: insert_game(integer, character varying, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: freecodecamp
--

CREATE FUNCTION public.insert_game(g_year integer, g_round character varying, g_winner text, g_opponent text, g_winner_goals integer, g_opponent_goals integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
  DECLARE
    selected_game_id INT;
  BEGIN
    INSERT INTO games(year, 
                      round, 
                      winner_id, 
                      opponent_id, 
                      winner_goals, 
...
ALTER FUNCTION public.insert_game(g_year integer, g_round character varying, g_winner text, g_opponent text, g_winner_goals integer, g_opponent_goals integer) OWNER TO freecodecamp;

--
-- Name: insert_or_select_team_id(text); Type: FUNCTION; Schema: public; Owner: freecodecamp
--

CREATE FUNCTION public.insert_or_select_team_id(team_name text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
  DECLARE
    selected_id INTEGER;
...
ALTER FUNCTION public.insert_or_select_team_id(team_name text) OWNER TO freecodecamp;
